...
def _bundle(tmp_path: Path) -> Path:
    ...
    _write_json(deterministic, {**common, "artifacts": package_rows})
    _write_json(rebuild, {**common, "artifacts": package_rows})
    _write_json(independent, {**common, "artifacts": package_rows})
    _write_json(
        offline,
        {
            **common,
