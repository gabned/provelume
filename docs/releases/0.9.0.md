...
correction overlays without automatic merge. Published package, runtime, embedded
...
PARENT_TRACKER: #137
DELIVERED_SLICES: 0.9/S01,0.9/S02,0.9/S03,0.9/S04,0.9/S05
DELIVERED_SLICE_ISSUES: #5,#140,#143,#149,#151
DELIVERED_SLICE_OWNER_PRS: #138,#141,#147,#150,#152
CURRENT_SLICE: 0.9/S06
CURRENT_SLICE_ISSUE: #153
CURRENT_SLICE_BRANCH: product/0.9-s06-cross-source-qualification
CURRENT_SLICE_OWNER_PR: PENDING
CURRENT_SLICE_STATE: ACTIVE_IMPLEMENTATION
NEXT_SLICE: 0.9/S07
...
## Active slice — 0.9/S06

S06 is owned by [#153](https://github.com/gabned/provelume/issues/153) on
`product/0.9-s06-cross-source-qualification`; its owner PR is assigned only after a real candidate
head exists. The candidate adds:
...
No S01/S02/S03/S04/S05/S06 commit creates a tag, release or asset and none changes package, `__version__`,
...
#152. `0.9/S06` cross-source qualification and correction findings is active under #153 on its
single product branch; its owner PR is bound only after the real candidate head exists. S07 Windows
shell/endpoint is the next forecast only and has no issue, branch or owner PR. Action
Center, AI, RAG, vision/remote OCR and every `0.10+` capability are outside this record. Port
`44851` remains an S07 roadmap decision and is unchanged by S06.
