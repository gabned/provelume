...
| Active development | `0.10.0` | Multimedia, universal content representations and component inventory | #160; S01–S06 delivered; S07 #180 active | `Perceptio` |
...
S06 is delivered under #177/#179; S07 is active under #180. #157 remains closed as not planned and no S08 exists.
...
active under #180. Package, runtime, embedded and Windows identity remain `0.9.0`; Perceptio is
...
#177/#179. S07 is the one active slice under #180 on
`product/0.10-s07-final-qualification`; its owner pull request follows exact-head upload.
