...
`S01`, `S02`, `S03` and `S04` are implemented under `Unreleased` while package identity remains
`0.5.1`. `S05` and the separate release-preparation/publishing gate remain outstanding.
