...
`collectPreflight` records complete bounded open-PR pages, details only for the
selected owner, ruleset inventory and bounded recent Actions. Policy denial and
missing thread completeness remain UNKNOWN. Recent Actions are an inventory,
